...
<html>
  <head>
    ...
    <title>iBanana - Listado de presupuestos</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row mt-2">
        <div class="col s4">
          <a href="{{ url('ver-todos-presupuestos') }}" class="waves-effect waves-light btn"><i class="material-icons left">remove_red_eye</i> Ver todos</a>
        </div>
      </div>
        ...
        <div class="row mt-2">
            <div class="col s12">
                <div class="row">
                    ...
                    <table class="presupuestos display compact">
                        <thead>
                          <tr>
                              <th>ID</th>
                              <th>DNI/NIE/CIF</th>
                        ...
                        <tbody>
                            ...
                            @php
                                $fecha1= new DateTime($pre->created_at);
                                $fecha2= new DateTime("now");
                                $diff = $fecha1->diff($fecha2);
                            @endphp

                            <tr>
                                <td class="center-align">{{ $pre->id }}</td>
                                <td class="center-align">{{ $pre->dni }}</td>
                                
                                <td class="center-align">{{ $pre->nombre }}</td>
                                ...
                                <td class="center-align">
                                    ...
                                    <a href="{{ url('eliminar-presupuesto/' . $pre->id )}}" class="waves-effect waves-light btn red darken-2"><i class="material-icons">close</i>
                                    </a>
                                    <a href="{{ url('documento-factura-presupuesto/' . $pre->id )}}" class="waves-effect waves-light btn blue-grey darken-2"><i class="material-icons">description</i>
                                    </a>
                                    <a href="" class="waves-effect waves-light btn blue darken-2"><i class="material-icons">mail</i>
                                    </a>
                                </td>
    ...
    <script type="text/javascript">
      // LLamada a tabla dinámica Datatables para los presupuestos.
      $(document).ready(function() {
        $('.presupuestos').DataTable({
            ...
            // Cuando se crea un nuevo presupuesto se muestra un mensaje dinámico de pedido creado con su número de orden
            @if(strlen($mensaje) > 0)
            $.alert({
