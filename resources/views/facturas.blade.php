  ...
  <body>
    ...
    <div class="container">
      <div class="row mt-2">
        <div class="col s12">
          <div class="row">
            <form id="factura" action="{{ url('crear-factura') }}" method="post" class="col s12">
              @csrf
              ...
              <div class="row">
                ...
                <div id="cajaGuardar" class="input-field col s4">
                  ...
                  <span> Es obligatorio guardar los componentes solo una vez antes de crear la factura</span>
                </div>
