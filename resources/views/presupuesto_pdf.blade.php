...
<head>
    ...
    <title>Hoja de presupuesto {{ $hoja_presupuesto->id }}</title>
...
<body>
    ...
    <div class="invoice-box">
        ...
        <table class="info_empresa">    
            <tr><td class="titulo">PRESUPUESTO</td></tr>
        ...
        <div class="derecha">
            ...
            <table class="info_cliente">
                <tr><td>{{ $hoja_presupuesto->nombre }}</td></tr>
                <tr><td>{{ $hoja_presupuesto->dni }}</td></tr>
                <tr><td>Fecha: {{ $hoja_presupuesto->created_at }}</td></tr>
                <tr><td>Título del proyecto: {{ $hoja_presupuesto->marca }} {{ $hoja_presupuesto->modelo }}</td></tr>
                <tr><td>Producto: {{ $hoja_presupuesto->producto }}</td></tr>
                <tr><td>Numero IMEI: {{ $hoja_presupuesto->nserie }}</td></tr>
