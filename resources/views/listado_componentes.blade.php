...
<html>
  ...
  <nav>
    ...
    <script type="text/javascript">
      // LLamada a tabla dinámica Datatables para los pedidos
      $(document).ready(function() {
          $('.pedidos').DataTable({
              ...
              // Cuando se crea un nuevo pedido se muestra un mensaje dinámico de pedido creado con su número de orden
              @if(strlen($mensaje) > 0)
              $.alert({
